...
if __name__ == '__main__':
    ...
    # prepare_and_send_email(sender='tanuj2020csds026@abesit.edu.in', recipient='tanuj2020csds026@abesit.edu.in', subject= 'Alert Alert Alert', message_text= 'Hi,\nSomeone is detected at the premises\n\n\n\nRegards,\nTanuj', im0 = cv2.imread("test.jpg"))
    pass
